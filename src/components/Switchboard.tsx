...
export function Switchboard({
  ...
  return (
    <div className="bg-parichay-bg">
      <section className="mx-auto grid max-w-7xl grid-cols-1 gap-16 px-6 py-12 text-left md:py-20 lg:grid-cols-[minmax(0,0.82fr)_minmax(420px,1fr)] lg:items-start lg:gap-12 xl:gap-24 lg:py-28 xl:py-32">
